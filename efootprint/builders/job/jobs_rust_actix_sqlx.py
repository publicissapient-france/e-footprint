...
JOB_DEFAULT_RAM_NEEDED = 8.733543 * 10^8
JOB_DEFAULT_CPU_NEEDED = 0.219136
JOB_DEFAULT_DURATION= 0.106336

TECH_CASE = "Rust Actix SQLX"


def rust_actix_sqlx_data_write(name=TECH_CASE+" Data Write", **kwargs):
    output_args = {
        "data_upload": 8000,
        "data_download": 2000,
...
def rust_actix_sqlx_data_read(name=TECH_CASE+" Data Read", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 4000,
        "request_duration": JOB_DEFAULT_DURATION,
...
def rust_actix_sqlx_data_list(name=TECH_CASE+" Data List", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 15000,
        "request_duration": JOB_DEFAULT_DURATION,
...
def rust_actix_sqlx_data_simple_analytic(name=TECH_CASE+" Data Simple Analytic", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 5000,
        "request_duration": JOB_DEFAULT_DURATION,
