...
JOB_DEFAULT_RAM_NEEDED = 2.774856 * 10^9
JOB_DEFAULT_CPU_NEEDED = 0.254605
JOB_DEFAULT_DURATION= 0.107558

TECH_CASE = "JVM Kotlin Spring"


def jvm_kotlin_spring_data_write(name=TECH_CASE+" Data Write", **kwargs):
    output_args = {
        "data_upload": 8000,
        "data_download": 2000,
...
def jvm_kotlin_spring_data_read(name=TECH_CASE+" Data Read", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 4000,
        "request_duration": JOB_DEFAULT_DURATION,
...
def jvm_kotlin_spring_data_list(name=TECH_CASE+" Data List", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 15000,
        "request_duration": JOB_DEFAULT_DURATION,
...
def jvm_kotlin_spring_data_simple_analytic(name=TECH_CASE+" Data Simple Analytic", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 5000,
        "request_duration": JOB_DEFAULT_DURATION,
