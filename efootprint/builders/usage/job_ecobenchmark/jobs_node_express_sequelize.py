...
JOB_DEFAULT_RAM_NEEDED = 6.192310 * 10^8
JOB_DEFAULT_CPU_NEEDED = 0.125053
JOB_DEFAULT_DURATION= 0.176207

TECH_CASE = "Node Express Sequelize"


def node_express_sequelize_data_write(name=TECH_CASE+" Data Write", **kwargs):
    output_args = {
        "data_upload": 8000,
        "data_download": 2000,
...
def node_express_sequelize_data_read(name=TECH_CASE+" Data Read", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 4000,
        "request_duration": JOB_DEFAULT_DURATION,
...
def node_express_sequelize_data_list(name=TECH_CASE+" Data List", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 15000,
        "request_duration": JOB_DEFAULT_DURATION,
...
def node_express_sequelize_data_simple_analytic(name=TECH_CASE+" Data Simple Analytic", **kwargs):
    output_args = {
        "data_upload": 1000,
        "data_download": 5000,
        "request_duration": JOB_DEFAULT_DURATION,
