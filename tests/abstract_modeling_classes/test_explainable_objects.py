...
class TestExplainableHourlyQuantities(unittest.TestCase):
    ...
    def test_addition_between_hourly_quantities(self):
    ...
    def test_addition_with_shifted_hourly_quantities(self):
        ...
        shifted_hour_usage = ExplainableHourlyQuantities(
            create_hourly_usage_df_from_list(self.usage2, self.start_date + timedelta(hours=nb_hours_shifted), pint_unit=u.W), "Usage 2")
        ...
        self.assertEqual(self.hourly_usage1.value_as_float_list[:2], sum_hourly_usage.value_as_float_list[:2])
        self.assertEqual(shifted_hour_usage.value_as_float_list[-2:], sum_hourly_usage.value_as_float_list[-2:])
    ...
    def test_create_empty_hourly_dimensionless_quantities_with_same_index(self):
        df = self.hourly_usage1.create_empty_hourly_dimensionless_quantities_with_same_index()
