...
class TestUsagePattern(unittest.TestCase):
    def test_compute_nb_occurences_in_parallel_entire_hour(self):
        ...
        result = compute_nb_occurences_in_parallel(input_occs_starts_hvals, event_duration)
        self.assertEqual(input_occs_starts, result.value_as_float_list)

    def test_compute_nb_occurences_in_parallel_2_hours(self):
        input_occs_starts = [20, 10, 14, 15]
        input_occs_starts_hvals = SourceHourlyValues(create_hourly_usage_df_from_list(input_occs_starts))
    ...
    def test_compute_nb_occurences_in_parallel_partial_hour(self):
        input_occs_starts = [20, 10, 14, 15]
        input_occs_starts_hvals = SourceHourlyValues(create_hourly_usage_df_from_list(input_occs_starts))
    ...
    def test_compute_nb_occurences_in_parallel_partial_hour_greater_than_one(self):
        input_occs_starts = [20, 10, 14, 15]
        input_occs_starts_hvals = SourceHourlyValues(create_hourly_usage_df_from_list(input_occs_starts))
